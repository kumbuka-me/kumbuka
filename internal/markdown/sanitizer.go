...
func newSanitizer() *bluemonday.Policy {
	...
	policy.AllowAttrs("data-kumbuka-plugin", "data-kumbuka-module").Matching(regexp.MustCompile(`^[a-z0-9][a-z0-9._-]{0,127}$`)).OnElements("div")
	policy.AllowAttrs("data-kumbuka-input").Matching(regexp.MustCompile(`^html$`)).OnElements("div")
	policy.AllowAttrs("data-kumbuka-fallback").OnElements("div")
